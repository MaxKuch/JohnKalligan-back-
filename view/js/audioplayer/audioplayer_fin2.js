$(document).ready(function(){
    const audioPlayerFinal2 = function(){
    let progressId = '#progress_fin2'
    let currentTimeId = '#time-current_fin2'
    let TotalTimeId = '#time-total_fin2'
    let playId = '#play_fin2'
    let volumeId = '#volume_fin2'
    let isDown=false;
    const songs=[
       [0, 'Финал ветра-проблемы 2', 'js/audioplayer/order-song-recordings/финал ветра-проблемы-2.mp3', '26.488163'],
    ];
