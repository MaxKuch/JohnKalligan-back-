$(document).ready(function(){
    const audioPlayerWinds = function(){
    let progressId = '#progress_winds'
    let currentTimeId = '#time-current_winds'
    let TotalTimeId = '#time-total_winds'
    let playId = '#play_winds'
    let volumeId = '#volume_winds'
    let isDown=false;
    const songs=[
       [0, 'Надя Минустина – Ветра-Проблемы (с моим вокалом)', 'js/audioplayer/order-song-recordings/Надя Минустина – Ветра-Проблемы (с моим вокалом).wav', '291.16254'],
    ];
