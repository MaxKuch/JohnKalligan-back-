$(document).ready(function(){
    const audioPlayerVocals = function(){
    let progressId = '#progress_vocals'
    let currentTimeId = '#time-current_vocals'
    let TotalTimeId = '#time-total_vocals'
    let playId = '#play_vocals'
    let volumeId = '#volume_vocals'
    let isDown=false;
    const songs=[
       [0, 'Вокал в far away до-после', 'js/audioplayer/order-song-recordings/вокал в far away до-после.mp3', '43.72898'],
    ];
