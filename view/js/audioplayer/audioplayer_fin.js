$(document).ready(function(){
    const audioPlayerFinal = function(){
    let progressId = '#progress_fin'
    let currentTimeId = '#time-current_fin'
    let TotalTimeId = '#time-total_fin'
    let playId = '#play_fin'
    let volumeId = '#volume_fin'
    let isDown=false;
    const songs=[
       [0, 'Финал ветра-проблемы', 'js/audioplayer/order-song-recordings/финал ветра-проблемы.mp3', '69.407347'],
    ];
